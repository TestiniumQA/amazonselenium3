...
* Reset butonuna tıklanır
* Şifremi unuttum mail kısmında "Lütfen bu alanı doldurun." hata mesajı alınır
...
* Reset butonuna tıklanır
* Şifremi unuttum mail kısmında "Lütfen e-posta adresine bir \"@\" işareti ekleyin." hata mesajı alınır
...
* Reset butonuna tıklanır
* Şifremi unuttum mail kısmında "Başında \"@\" bulunan kısımda \"<\" simgesi bulunmamalıdır." hata mesajı alınır